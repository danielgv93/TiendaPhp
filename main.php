...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
                        ...
                        <input type="submit" class="dropdown-item" value="Teléfonos"> <!--RATON MANO EN HOVER POR CSS-->
                    </form>
                    <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
        ...
        <form method="post" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" class="form-inline my-2 my-lg-0">
            <input class="form-control mr-sm-2" name="busquedaInput" type="search" placeholder="Buscar"
                   aria-label="Search">
            <input type="submit" class="btn btn-primary btn-warning" name="buscar" id="buscar"> <span
    ...
    <table>
        <?php foreach ($arrayDispositivos as $id => $producto) : ?>
            ...
            <form action="producto.php" method="get">
                ...
                <tr>
                    <input type="submit" name="ficha" value="Ver Ficha">
                </tr>
            </form>
        <?php endforeach; ?>
    </table>
