...
if (isset($_POST["modificarPerfil"])) {
    if (!empty($_POST["contraseña"])) {
        if (Database::getInstance()->updateUsuario($_SESSION["visitante"]->getId(), $_POST["nombre"], $_POST["apellidos"],
            $_POST["usuario"], $_POST["email"], $_POST["contraseña"])) {
            $_SESSION["visitante"] = Database::getInstance()->getUsuario($_SESSION["visitante"]->getId());
...
<?php if (isset($_SESSION["visitante"])) : ?>
    ...
    <div class="container">
        <div class="row profile">
            <div class="col-md-3">
                <div class="profile-sidebar <?php if ($_SESSION["visitante"]->getAdmin() == 1) echo "gold"; ?>">
                    <div class="profile-userpic">
                        <img src="<?= $_SESSION["visitante"]->getFotoPerfil() ?>" class="img-responsive ml-5 imagenPerfil"
                             alt="Foto perfil">
                        <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post"
                              enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?= $_SESSION["visitante"]->getId() ?>">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="imagen" id="customFileLang"
                                       lang="es">
                                <label class="custom-file-label" for="customFileLang">Seleccionar Foto</label>
                            </div>
                            <button type="submit" name="updateFoto" class="btn btn-info mt-2 ml-5">Actualizar foto
                            </button>
                        </form>
                    </div>
                    <div class="profile-usertitle">
                        <div class="profile-usertitle-name mr-4 <?php if ($_SESSION["visitante"]->getAdmin() == 1) echo "gold-user"; ?>">
                            <?= $_SESSION["visitante"]->getNombre() . " " . $_SESSION["visitante"]->getApellidos() ?>
                        </div>
                        <div class="profile-usertitle-job mr-4 mb-4 <?php if ($_SESSION["visitante"]->getAdmin() == 1) echo "gold-user"; ?>">
                            <?php
                            if ($_SESSION["visitante"]->getAdmin() == 1) {
                                echo "Administrador";
                            } else {
                                echo "Usuario";
                            }
                    ...
                    <?php if ($_SESSION["visitante"]->getAdmin() == 1) : ?>
                        <div class="profile-userpic">
                            <img src="img/modificarTienda.svg" class="img-responsive ml-5 imagenPerfil"
                                 alt="Foto perfil">
                        </div>
                        <div class="profile-usertitle">
            ...
            <div class="col-md-9">
                <div class="row py-5 p-4 bg-white rounded shadow-sm">
                    <div class="col-lg-12">
                        ...
                        <form class="formulario" id="modificar-perfil"
                              action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" role="form">
                            <label for="nombre">Nombre:</label>
                            <div class="form-group">
                                <i class="fas fa-signature d-inline"></i>
                                <input class="form-control d-inline" type="text" name="nombre" id="nombre" readonly
                                       value="<?= $_SESSION["visitante"]->getNombre() ?>">
                            ...
                            <div class="form-group">
                                <i class="fas fa-signature d-inline"></i>
                                <input class="form-control d-inline" type="text" name="apellidos" id="apellidos"
                                       readonly value="<?= $_SESSION["visitante"]->getApellidos() ?>">
                                <button type="button" onclick="function habilitar() {
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control d-inline" type="text" name="usuario" id="usuario" readonly
                                       value="<?= $_SESSION["visitante"]->getUsuario() ?>">
                                <button type="button" onclick="function habilitar() {
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control d-inline" type="text" name="email" id="email" readonly
                                       value="<?= $_SESSION["visitante"]->getEmail() ?>">
                                <button type="button" onclick="function habilitar() {
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control d-inline" type="password" name="contraseña" id="contraseña"
                                       readonly>
                                <button type="button" onclick="function habilitar() {
